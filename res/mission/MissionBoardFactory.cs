    ...
    public static IReadOnlyList<MissionData> CreateDefaultBoard()
    {
        ...
        return new MissionData[]
        {
            ...
            new(
                ...
                failureHeat: 1),
            new(
                id: "mission_extract_logs",
                title: "Operator Manifest",
                client: helixOps,
                briefing: "Follow-up to Cache Recon — pull the system.log before the next audit cycle overwrites the entries we flagged.",
                objectiveType: MissionObjectiveType.Extract,
                ...
                failurePenaltyCredits: 20,
                failureHeat: 2,
                prerequisiteMissionId: "mission_scan_cache",
                requiredFactionReputation: 1),
            new(
